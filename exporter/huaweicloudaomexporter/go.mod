module github.com/open-telemetry/opentelemetry-collector-contrib/exporter/huaweicloudaomexporter
...
require (
	...
	github.com/huaweicloud/huaweicloud-lts-sdk-go v0.0.0-20250527071047-e5de19cfe5aa
